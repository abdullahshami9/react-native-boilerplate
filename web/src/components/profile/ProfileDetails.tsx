...
import { GraduationCap, Code, FileText } from 'lucide-react'
      ...
      {skills.length > 0 && (
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
             <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-bold text-lg text-gray-900 dark:text-white">Professional Skills</h3>
             </div>
      ...
      {resumeUrl && (
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 flex justify-between items-center">
              <div className="flex items-center gap-3">
                  ...
                  <div>
                      <h3 className="font-bold text-gray-900 dark:text-white">Resume</h3>
                      <p className="text-sm text-gray-500">View detailed professional history</p>
                  </div>
              </div>
              <a href={`http://localhost:3000/${resumeUrl}`} target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-junr-blue text-white rounded-lg text-sm font-bold hover:bg-blue-600 transition">
                  Download
              </a>
          </div>
      )}
