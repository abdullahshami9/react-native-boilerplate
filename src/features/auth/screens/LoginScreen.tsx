...
const LoginScreen = ({ navigation }: any) => {
    ...
    const { login, biometricLogin, googleLogin } = useContext(AuthContext);
    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            ...
            showAlert('Google Login Failed', error.message || 'Something went wrong', 'error');
        }
    };

    const [biometryType, setBiometryType] = useState<string | undefined>(undefined);
    // Initialize biometrics only if not web
    const rnBiometrics = !isWeb ? new ReactNativeBiometrics() : null;

    React.useEffect(() => {
        if (!isWeb && rnBiometrics) {
        ...
        <ScrollView contentContainerStyle={styles.contentContainer}>
            ...
            <View style={styles.content}>
                ...
                <View style={styles.welcomeSection}>
                    <Text style={[styles.welcomeText, { color: theme.text }]}>Hey,{'\n'}Welcome{'\n'}Back</Text>
                </View>
                ...
                <View style={styles.formSection}>
                    ...
                    {/* Google Button */}
                    <TouchableOpacity style={[styles.googleButton, { backgroundColor: 'rgba(255, 255, 255, 0.6)', borderColor: theme.inputBorder }]} onPress={handleGoogleLogin}>
            ...
            {isWeb ? (
                <View style={{ flex: 1, flexDirection: 'row' }}>
                    <View style={{ flex: 1, backgroundColor: '#00a884', justifyContent: 'center', alignItems: 'center' }}>
                        <Image
                            source={LocalAssets['business_technology']}
