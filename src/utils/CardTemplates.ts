    ...
    standard: (data: any) => `
        ...
        <head>
            <style>
                ...
                .hologram { position: absolute; top: -50px; right: -50px; width: 150px; height: 150px; background: linear-gradient(45deg, ${data.color || '#00f260'}, #0575e6); border-radius: 50%; opacity: 0.1; filter: blur(30px); }
                .hologram2 { position: absolute; bottom: -30px; left: -30px; width: 100px; height: 100px; background: linear-gradient(45deg, ${data.color || '#ff0099'}, #493240); border-radius: 50%; opacity: 0.05; filter: blur(20px); }

                .logo { width: 60px; height: 60px; border-radius: 18px; background: #fff; margin-right: 20px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); object-fit: contain; z-index: 2; padding: 5px; box-sizing: border-box; }
                ...
                .role { font-size: 13px; color: ${data.color || '#718096'}; margin-bottom: 12px; font-weight: 500; text-transform: uppercase; letter-spacing: 1px; }
                ...
                .qr-container { padding: 8px; background: white; border-radius: 12px; box-shadow: 0 0 20px ${data.color ? data.color + '4D' : 'rgba(0,242,96,0.3)'}; z-index: 2; }
                .scan-text { margin-top: 15px; font-size: 10px; text-transform: uppercase; letter-spacing: 2px; color: ${data.color || '#a0aec0'}; z-index: 2; }
            </style>
        </head>
        <body>
            <div class="page">
    ...
    broker: (data: any) => `
        ...
        <head>
            <style>
                ...
                .ticker { position: absolute; top: 10px; white-space: nowrap; font-family: monospace; color: ${data.color || '#00ff00'}; font-size: 10px; animation: scroll 10s linear infinite; opacity: 0.8; }
                ...
                .name { font-family: 'Cinzel', serif; font-size: 22px; color: ${data.color || '#d4af37'}; border-bottom: 2px solid ${data.color || '#d4af37'}; padding-bottom: 5px; display: inline-block; margin-bottom: 10px; text-shadow: 0 2px 4px rgba(0,0,0,0.5); }
                ...
                .stat-val { font-size: 12px; color: ${data.color || '#00ff00'}; font-weight: bold; }

                .card-back { background: #000; border: 1px solid ${data.color || '#d4af37'}; display: flex; justify-content: center; align-items: center; flex-direction: column; }
                .gold-border { padding: 5px; border: 2px solid ${data.color || '#d4af37'}; border-radius: 8px; }
            </style>
        </head>
        <body>
            <div class="page">
            ...
            <div class="page">
                <div class="card card-back">
                    ...
                    <div style="margin-top: 15px; color: ${data.color || '#d4af37'}; font-family: 'Cinzel', serif; letter-spacing: 2px;">INVEST IN SUCCESS</div>
                </div>
            </div>
        </body>
        </html>
        ...
        <head>
            <style>
                ...
                .card {
                    ...
                    border: 4px solid ${data.color || '#d2691e'};
                    display: flex;
                    align-items: center;
                ...
                .name { font-family: 'Pacifico', cursive; font-size: 26px; color: ${data.color || '#8b4513'}; margin-bottom: 5px; text-shadow: 1px 1px 0px rgba(255,255,255,0.5); }
                .role { font-size: 14px; color: #d2691e; font-weight: 600; margin-bottom: 15px; }
                .contact { font-size: 11px; color: #5d4037; line-height: 1.5; }

                .nutrition-facts {
                    z-index: 2; width: 35%; height: 100%; border-left: 2px dashed ${data.color || '#d2691e'};
                ...
                .card-back { background: ${data.color || '#8b4513'}; color: white; flex-direction: column; justify-content: center; }
    ...
    dentist: (data: any) => `
        ...
        <head>
            <style>
                ...
                .blue-wave { position: absolute; bottom: 0; left: 0; width: 100%; height: 40%; background: ${data.color || '#00acc1'}; border-radius: 100% 100% 0 0 / 20px 20px 0 0; transform: scaleX(1.5); }
                .tooth-bg { position: absolute; top: 10px; right: 20px; font-size: 120px; opacity: 0.05; color: ${data.color || '#00acc1'}; }

                .content { padding: 30px; position: relative; z-index: 10; }
                .name { font-size: 22px; font-weight: 700; color: #006064; }
                .role { font-size: 12px; color: ${data.color || '#0097a7'}; letter-spacing: 1px; text-transform: uppercase; margin-bottom: 15px; font-weight: 500; }
                ...
                .card-back { background: ${data.color || '#00acc1'}; display: flex; flex-direction: column; justify-content: center; align-items: center; }
    ...
    tech_terminal: (data: any) => `
        ...
        <head>
            <style>
                ...
                .card { width: 350px; height: 200px; background: #0d1117; border: 1px solid #30363d; border-radius: 10px; overflow: hidden; box-shadow: 0 0 20px ${data.color ? data.color + '33' : 'rgba(0, 255, 0, 0.1)'}; }
                ...
                .cursor { display: inline-block; width: 8px; height: 14px; background: ${data.color || '#58a6ff'}; animation: blink 1s step-end infinite; vertical-align: middle; }
                @keyframes blink { 50% { opacity: 0; } }

                .card-back { background: #0d1117; display: flex; flex-direction: column; justify-content: center; align-items: center; }
                .qr-border { border: 2px solid ${data.color || '#58a6ff'}; padding: 5px; border-radius: 5px; box-shadow: 0 0 15px ${data.color ? data.color + '66' : 'rgba(88, 166, 255, 0.4)'}; background: white; }
            </style>
        </head>
        <body>
            <div class="page">
            ...
            <div class="page">
                <div class="card card-back">
                    ...
                    <div style="margin-top: 15px; color: ${data.color || '#58a6ff'}; font-size: 12px;">$ git clone contact_info</div>
                </div>
            </div>
        </body>
        </html>
    ...
    mechanic_tool: (data: any) => `
        ...
        <head>
            <style>
                ...
                .role { font-size: 14px; font-weight: bold; color: ${data.color || '#c0392b'}; background: #fff; display: inline-block; padding: 2px 8px; transform: skew(-10deg); margin-bottom: 15px; box-shadow: 2px 2px 5px rgba(0,0,0,0.2); }
                ...
                .warning-stripe { width: 100%; height: 30px; background: repeating-linear-gradient(45deg, ${data.color || '#f1c40f'}, ${data.color || '#f1c40f'} 10px, #222 10px, #222 20px); position: absolute; bottom: 40px; opacity: 0.8; }
            </style>
        </head>
        <body>
            <div class="page">
            ...
            <div class="page">
                <div class="card card-back">
                    ...
                    <div style="background: #fff; padding: 5px; border: 2px solid ${data.color || '#f1c40f'}; border-radius: 5px; z-index: 10;">
                        ${data.qrCode}
                    </div>
                    <div style="margin-top: 15px; color: ${data.color || '#f1c40f'}; font-family: 'Russo One'; z-index: 10; font-size: 16px;">SCAN FOR REPAIRS</div>
    ...
    split_card: (data: any) => `
        ...
        <head>
            <style>
                ...
                .left { width: 50%; background: ${data.color || '#2c3e50'}; color: white; display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 20px; text-align: center; }
                .right { width: 50%; background: #ecf0f1; color: ${data.color || '#2c3e50'}; display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 20px; text-align: center; }
        ...
        <body>
            <div class="page">
                <div class="card">
                    ...
                    <div class="right">
                        <div class="name-lg" style="color: ${data.color || '#2c3e50'};">${data.name}</div>
    ...
    finger_play: (data: any) => `
        ...
        <head>
            <style>
                ...
                .card {
                    width: 350px; height: 200px;
                    background: ${data.color || '#a8e6cf'}; /* Mint green yoga mat color */
                    border-radius: 15px;
                    position: relative;
                ...
                .role { font-size: 14px; color: ${data.color ? '#fff' : '#ff8b94'}; font-weight: bold; letter-spacing: 2px; text-transform: uppercase; margin-bottom: 20px; z-index: 2; text-shadow: 0 1px 2px rgba(0,0,0,0.1); }
                ...
                .card-back { background: ${data.color || '#ff8b94'}; color: white; }
        ...
        <head>
            <style>
                ...
                .card {
                    ...
                    background: linear-gradient(to right, ${data.color || '#4facfe'} 0%, ${data.color ? data.color + 'aa' : '#00f2fe'} 100%);
                    color: white;
                    padding: 20px;
                ...
                .role { font-size: 14px; font-weight: bold; margin-bottom: 10px; background: white; color: ${data.color || '#00f2fe'}; padding: 2px 8px; display: inline-block; }
        ...
        <body>
            <div class="page">
                <div class="card-container">
                    <div style="position: absolute; top: -20px; right: 0; color: ${data.color || '#4facfe'}; font-size: 10px; font-weight: bold;">GROWTH TRAJECTORY</div>
                    <div class="card">
